...
const Inventory: React.FC = () => {
    ...
    const [formData, setFormData] = useState<Item>({ id: 0, name: '', category: '', price: 0, stock: 0, quantity: 0 });
    ...
    const handleEdit = (item: Item) => {
        setCurrentItem(item);
        setFormData({ id: item.id, name: item.name, category: item.category, price: item.price, stock: item.stock, quantity: item.quantity });
        setShowModal(true);
    };
